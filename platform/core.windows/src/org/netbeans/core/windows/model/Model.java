...
public interface Model {
    ...
    /** Sets visibility status. (of all managed windows) */
    ...
    /** Removes mode. (window association can be looked up from the mode) */
    ...
    /** Sets editor mode that is currently maximized */
    public void setEditorMaximizedMode(NbWindowImpl window, ModeImpl maximizedMode);

    /** Sets view mode that is currently maximized */
    public void setViewMaximizedMode(NbWindowImpl window, ModeImpl maximizedMode);

    /** Adds mode. */ 
    public void addMode(NbWindowImpl window, ModeImpl mode, SplitConstraint[] constraints); // NEW

    /** Adds mode. */
    public void addModeToSide(NbWindowImpl windw, ModeImpl mode, ModeImpl attachMode, String side);  // NEW
